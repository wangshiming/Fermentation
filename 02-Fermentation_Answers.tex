...
\addtocounter{questions}{1}
\color{blue}
Which effects can mutations in the DNA of microorganisms have? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
pesticide? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
you expect to be abundant around volcanoes? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
What is the typical order of magnitude for the size of microorganisms? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Where do you expect to find the largest variety of microorganisms? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Wet cells mostly consist of: (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which of the following compounds are required to produce biomass $C_1H_{1.80}O_{0.5}N_{0.2}$ (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
An example of an inorganic compound required for microbial growth is:  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Where do microorganisms get the energy to ‘drive’ the synthesis of biomass (anabolism)?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Dried biomass mostly contains:  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
{\color{red}$\circ$} Lipids\\
{\color{red}$\circ$} RNA\\
...
\addtocounter{questions}{1}
\color{blue}
A microorganism grows on methanol and uses $NO_{3}N^{-}$ as N-source. Which compounds does the anabolic reaction for biomass formation contain?   (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which compounds can function as N-source?   (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which of the following nutrients can be synthesized by microorganisms?   (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
{\color{red}$\circ$}  Trace metals\\
...
\addtocounter{questions}{1}
\color{blue}
Lipids are present in:   (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
{\color{red}$\circ$} DNA\\
{\color{red}$\circ$} RNA\\
...
\addtocounter{questions}{1}
\color{blue}
Which of the following compounds can be an electron acceptor?   (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
{\color{red}$\bullet$}  ${NO_{3}}^{-}$\\
...
\addtocounter{questions}{1}
\color{blue}
Which of the following compounds can be an electron donor?   (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which balance must be set up to calculate the rate of product production “$R_p$” from experimental measurement in a fermenter? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which measurements are needed to calculate the production rate $R_p$ in a continuous process of a non-volatile stable product ? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
If you know that no product enters a fermenter in the inflow, no product is consumed (e.g. in a degradation reaction), and the product is not volatile, the compound balance for this product can be formulated as:(\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
What’s the unit of $R_p$ in the product balance when concentrations are given in mol/L?(\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
{\color{red}$\triangleright$} Analysis of product concentration in the broth filtrate in mol P/m3 broth filtrate\\[0.5em]
  ...
  Give the unit of $F_{out}$ in the product balance which is needed to calculate $R_p$ (in mol P/h)(\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
When other mechanisms (degradation, evaporation) apply to the product, then the calculated. $R_p$ (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
In a continuous process Rp must be calculated in mol product/h. The molar mass of the product is 110 g/mol. The following measurements are available:({\color{red}{Q\arabic{questions} Answers}})\\[0.3em]
\color{gray}
\begin{tabular}[]{l l l}
...
\addtocounter{questions}{1}
\color{blue}
Which balance is needed to obtain $R_s$? (\color{red}{Q\arabic{questions} Answers})\\[0.3em]
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which measurements are needed to obtain $R_s$ in a steady state continuous process?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which assumptions have been made in setting up the balance you would use to calculate $R_s$ (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
What could be the units of $T_{N,O}$ in the gas phase $O_2$-balance for a fermenter? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which of the following terms are present in a gas phase O2-balance?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
In which combination of the following situations are the molar gas in- and outflows equal?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
Which additional balance(s) (and their measurements) is/are needed to apply N-conservation? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which balance(s) is/are needed to calculate $F_{N,out}$ (in mol gas/h)?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
What could be the reason your carbon balances do not close?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Why is it practically impossible to use the broth water balance to obtain accurate values of RW (mol H2O/h produced or consumed) in fermentation processes?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\begin{frame}[shrink] {}
\addtocounter{questions}{1}
\color{blue} For sterility reasons the air sparged into the fermenter is dry. The gas which leaves the fermenter is saturated with water. Measurements of O2 and CO2 mole fractions in the off-gas (gas that leaves the fermenter) therefore require a special treatment of the gas before it can be measured. Which treatment is this?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Previously we used C-conservation as a check on the obtained values of $R_x$, $R_S$ and $R_P$.  Which other conservation relations can we apply?  (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
 Which is the correct general equation to obtain $\mu$ from measurements? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which of the following changes leads to a change in the steady state $\mu$ value in a chemostat which is always operated at Fout=0.10 $m^{3}/h$ and $V_L$=1.00$m^3$? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which of the following $q_s$-rates are incorrect? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
How can we compare the performance of different microorganisms? You can assume that the product is secreted. (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
How can we test whether ideal broth outflow in a chemostat is realized? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
 What are important characteristics of a steady state process? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which assumptions are important to verify when setting up component balances for a chemostat? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
In a chemostat with ideal broth outflow an organism makes a product. The following measurements are available: (\color{red}{Q\arabic{questions} Answers})\\
\color{gray}
 \begin{tabular}[ ]{l l l}
Measurement & Value & Unit \\
$V_L$ & 5.00 & $m^3$ \\
...
\addtocounter{questions}{1}
\color{blue}
Which phenomena in a batch fermentation contribute to an increasing or decreasing broth mass in time? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Which terms do not occur in the broth O2 – balance in a batch fermentation? (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
(Assume that the density of biomass is 1 kg/L) (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
...
\addtocounter{questions}{1}
\color{blue}
In question 3 an essential assumption about the product was made: (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
Broth is: (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
\addtocounter{questions}{1}
\color{blue}
The batch balance of a volatile substrate has the following terms: (\color{red}{Q\arabic{questions} Answers})\\
\color{black}
\setlength{\parindent}{-0.4cm}
...
% <input name="input_85638be7a75c430286607aaf4317b06b_2_1[]" id="input_85638be7a75c430286607aaf4317b06b_2_1_choice_1" aria-role="radio" aria-describedby="answer_85638be7a75c430286607aaf4317b06b_2_1" value="choice_1" aria-multiselectable="true" type="checkbox"> F<font size="1"><sub>N,out</sub></font>(t) y<font size="1"><sub>O,out</sub></font>(t)
\end{frame}
\end{document}
